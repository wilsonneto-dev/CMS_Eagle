...
$sel_grupo = new SqlSelect("SELECT id as valor, nome as texto FROM grupo_admin WHERE codprojeto = ".CODPROJETO." AND ativo = 1 and hierarquia >= {$grupo_admin->hierarquia} ORDER BY nome"); 
...
$page->form_fields = array(
	...
	array( "value" => $p->email, "name" => "email", "label" => "E-mail *", "required" => true, "autofocus" => true ),
