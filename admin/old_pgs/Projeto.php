...
$r->sql = "
	...
	FROM 
		projeto as b
		left join categoria c on b.cod_categoria = c.id and c.ativo = 1
	WHERE 
...
$page->table = true;
$page->table_header = "<th>Projeto</th><th>Categoria</th>";
