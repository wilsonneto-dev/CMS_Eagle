...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ){
	...
	if( $p->cadastrar() ){
		LogAdmin::_salvar( "Servico Cadastrado", "Servico" , $admin->id , "", json_encode( $p ) );
		addOnloadScript("message('Cadastrado com sucesso.','sucess');");
	} else {
		LogAdmin::_salvar( "Erro ao cadastrar Servico", "Servico" , $admin->id , "", json_encode( $p ) );
...
$page->title = "Cadastrar Servi&ccedil;o";
$page->page = "Servico";
$page->back_link = true;
