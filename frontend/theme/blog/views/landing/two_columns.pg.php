	    ...
	    <!-- header class="container-fluid">
	      <div id="sticky-header-nav">
	        <nav class="main-nav" role="navigation">
	          <div class="logo"> <a href="/" target="_blank"><img style="height: 35px;" src="/<?php $this->out( $this->infos->logo_header, ['type'=>'html']); ?>"></a></div>
	        </nav>
	      </div>
	    </header -->
...
(
    ...
    '<div style="text-align: center;">
    	<br />
		<iframe width="560" height="315" src="#inner" frameborder="0" allowfullscreen style="width: 90%; max-width: 560px; "></iframe>
	</div>',
	$this->obj->video != ''
);
