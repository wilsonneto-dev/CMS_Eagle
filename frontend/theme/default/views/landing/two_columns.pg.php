...
(
    ...
    '<div style="text-align: center;">
    	<br />
		<iframe width="560" height="315" src="#inner" frameborder="0" allowfullscreen style="max-width: 95%"></iframe>
	</div>',
	$this->obj->video != ''
);
...
$this->out_if
(
	$this->obj->imagem_quadrada,
    '<div style="text-align: center;">
    	<br />
    	<img src="\#inner" style="max-width: 90%;" />
	</div>',
	$this->obj->imagem_quadrada != ''
);
	              ...
	              <div class="rich-text">
	                <div class="textindent">
	                  <div class="font-18 darkgreen">
	                    <p><?php $this->out( $this->obj->texto_pre_form ); ?></p>
	                  </div>
...
?>	
	    ...
	    <footer>
	      ...
	      <a href="mailto://contato@dsacao.com.br">contato@dsacao.com.br</a> - 17 3363-2975<br />
	      D&amp;S A&ccedil;&atilde;o - Desenvolvendo pessoas e empresas &copy; 2017
	      </div>
	      <br />
	    </footer>
