...
// não será necessário manter os parametros na memória por hora
// $_parametros = Parametro::_getArray();
...
<html>
    <head>
        ...
        <!-- sweet alert -->
        <link rel="stylesheet" type="text/css" href="/admin/js/sweetalert/dist/sweetalert.css">
